...
if __name__ == '__main__':
    ...
    # 读取npz文件
    # """
    # network = np.load("data/CarModel/Model001.npz", allow_pickle=True)
    # print(network.files)  # ['connections', 'positions']，边和点
    # print(np.array(network['connections']).shape)  # (103872, 2)，边数和边的两个顶点
    # print(np.array(network['positions']).shape)  # (14844, 3)，点数和点的三维坐标
    #
    # """
